...
const VALUE_TO_ASSEMBLYSCRIPT = [
  ...
  ['[Timestamp]', 'Array<i64>', (code: any) => `${code}.toI64Array()`],
  ...
  ['Timestamp', 'i64', (code: any) => `${code}.toI64()`],
...
const ASSEMBLYSCRIPT_TO_VALUE = [
  ...
  ['Array<Array<i64>>', '[[Timestamp]]', (code: any) => `Value.fromI64Matrix(${code})`],
  ...
  ['Array<i64>', '[Timestamp]', (code: any) => `Value.fromI64Array(${code})`],
  ...
  ['i64', 'Timestamp', (code: any) => `Value.fromI64(${code})`],
