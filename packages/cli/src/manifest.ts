...
const Schema = z.object({
  file: z
    .string()
    .describe("The path of the GraphQL IDL file, either local or on IPFS."),
});
...
const DataSource = z.object({
  kind: z
    .string()
    .describe("The type of data source. Possible values: ethereum/contract."),
  name: z
    .string()
    .describe(
  ...
  source: EthereumContractSource.describe(
...
export const Manifest = z.object({
  ...
  description: z
    .string()
    .describe("An optional description of the subgraph's purpose.")
    .optional(),
  repository: z
    .string()
    .describe("An optional link to where the subgraph lives.")
    .optional(),
